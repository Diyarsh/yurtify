...
const translations = {
  ...
  kz: {
    ...
    'hero.title2': 'Премиум жылжымайтын мүлкіне инвестиция',
    'hero.subtitle': 'Астананың премиум жылжымайтын мүлкіне бөлшектеп меншік ету арқылы инвестиция салыңыз. Блокчейн токенизациясы арқылы сатып алыңыз, сатыңыз және жалға беру табысын алыңыз.',
  ...
  ru: {
    ...
    'hero.title2': 'Премиум недвижимость Астаны',
    'hero.subtitle': 'Инвестируйте в премиум недвижимость Астаны с долевым владением. Покупайте, продавайте и получайте доходы от аренды через блокчейн токенизацию.',
