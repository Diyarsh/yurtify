  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-primary-foreground shadow-primary hover:shadow-lg hover:scale-105 transition-bounce",
        accent: "gradient-accent text-accent-foreground shadow-accent hover:shadow-lg hover:scale-105 transition-bounce",
        hero: "gradient-hero text-white shadow-large hover:shadow-xl hover:scale-105 transition-bounce font-semibold",
      },
      size: {
